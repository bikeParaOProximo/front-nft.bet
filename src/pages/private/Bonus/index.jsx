...
export default function Bonus(){
  ...
  return(
    <Container estilizacao={"aninharHorizontalmente"}>
      <div className={styles.containerInfosBonus}>
        <div className={styles.infosBonus}>
          <div className={styles.magemInfosBonus}>
            <p className={styles.subtituloInfoBonus}>Código bonûs</p>
            <p className={styles.textoInfoBonus}>Utilioze códigos bonûs para ganhar valores fixos ou percentuais dentro do site.</p>

            <p className={styles.subtituloInfoBonus}>Como usar</p>
            <p className={styles.textoInfoBonus}>Basta copiar o código de 4 dígitos do bonûs, e inserir o mesmo no campo opcional "código bonûs" do cadastro ou depósito.</p>
            ...
            <ul>
              ...
              <li>Necessário estar dentro do prazo de validade.</li>
            ...
            <p className={styles.textoInfoBonus}>Todo código bonûs adciona uma auditoria extra a ser feita.</p>
          </div>
        </div>
      </div>
      {
